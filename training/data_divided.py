...
def main():
    source_codes = []
    # source_folder = './training/source/rust_source'
    source_folder = './training/source/fuzz_source'
    ...
    save_data(train_data, './training/data/train_dataset_fuzz.jsonl')
    save_data(valid_data, './training/data/valid_dataset_fuzz.jsonl')
    save_data(test_data, './training/data/test_dataset_fuzz.jsonl')
